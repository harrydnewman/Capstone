    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.body}>
                ...
                <h4>Your image is never saved or stored on our server. Once the classification is complete, it’s gone. We’re not building a database, and we’re not watching you, we’re showing you how the systems that are watching you really work.</h4>
